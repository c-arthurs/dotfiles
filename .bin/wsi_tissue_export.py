...
from wsi_toolbox import wsi_tissue_export #pip install --upgrade git+ssh://git@github.com/c-arthurs/wsi_toolbox.git#egg=wsi_toolbox
import sys 
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('path', type=str, 
            help='The path to the folder of wsi ending in a /')
    ...
    wsi_tissue_export.main(str(args.path), annotation_segment=bool(args.annotation_segment), 
